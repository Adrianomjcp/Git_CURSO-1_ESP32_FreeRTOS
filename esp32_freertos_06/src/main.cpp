...
void vTask1( void *pvParameters ){
  ...
  //essa marca me mostra NULL - me diz quantos bytes tenho livre na minha Task1
  //essa marca d'agua me mostra o nível de consumo onde eu quero..
  ...
  for( ;; ){
    ...
    uxHighWaterMark = uxTaskGetStackHighWaterMark( NULL );
    vPrintStringAndNumber( "Size: ", uxHighWaterMark ); //imprimindo quantos bytes tenho livres
