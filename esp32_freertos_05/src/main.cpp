...
void vTask1( void *pvParameters ){
  ...
  for( ;; ){
    ...
    vTaskDelay( 10000 / portTICK_PERIOD_MS ); //A CADA 10s RODA A TASK 1
  }
}
...
void vTask2( void *pvParameters ){
  ...
  for( ;; ){
    ...
    vTaskDelay( 500 / portTICK_PERIOD_MS ); //O OUTRO CORE A CADA 500ms RECEBE UMA MENSAGEM E PRINTA NA SERIAL
  }
}
...
void loop() {
  vTaskDelay( 100 / portTICK_PERIOD_MS ); //estou tirando o foco da task loop
}
